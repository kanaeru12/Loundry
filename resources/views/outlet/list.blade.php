...
<a href="{{ route('outlet.create') }}" class="btn btn-primary mb-3" style="background-color: #666262; color: rgb(0, 0, 0)">Tambah Outlet</a>
...
<table class="table table-bordered table-stripped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('outlet.edit', $out->id) }}" class="btn mr-2 rounded-circle py-2" style="background-color: rgb(238, 204, 9);"><i class="fas fa-fw fa-pen text-white"></i></a>
