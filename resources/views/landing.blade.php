...
<head>
    ...
    <!-- Font -->
    <link href="https://fonts.googleapis.com/css2?family=Unito&display=swap" rel="stylesheet">
...
<body>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    <h4>Peralatan Lengkap dan Hygienis</h4>
                    <p>Laundry self-service yang cepat, murah dan hygienis. Peralatan kami memungkinkan
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-md-6 mb-4 mb-sm-0">
                    <h5>Alamat</h5>
                    <p> Jl Raya Wisma Tropodo T16, Tropodo Wetan, Tropodo, Kec. Waru, Kabupaten Sidoarjo, Jawa Timur 61256 </p>
                    <br>
                    <h5>Kontak</h5>
                    <p><li><a href="https://www.tiktok.com/nt_hamskie/?hl=id"> Tiktok</a></li></p>
                    <p>081334387321</p>
                </div>
                <div class="col-md-6">
                    <iframe
